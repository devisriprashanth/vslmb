...
const Clientform = () => {
  ...
  return (
    <>
    <section className="w-full h-screen md:h-auto bg-cover bg-center flex justify-center items-center p-4" style={{ backgroundImage: `url(${form1})` }}>
      <div className="bg-white/80 rounded-xl w-full max-w-lg p-6"> 
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center border border-gray-300 rounded-md  bg-white">
            ...
            <select className=" py-2  rounded-md w-full text-lg bg-white">
          ...
          <p className="text-center text-lg">Want to add doc? <span className="text-secondary cursor-pointer" onClick={() => navigate("/upload")}>Upload</span></p>
          <button className="p-2 bg-secondary text-white text-lg rounded-md hover:shadow-xl cursor-pointer" onClick={() => navigate('/filter')}>SUBMIT</button>
        </div>
      </div>
    </section>
    </>
