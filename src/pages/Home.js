...
const Home = () => {
  ...
  return (
    <>
      <section>
        {/* Hero Section */}
        <div className="flex flex-col h-auto bg-cover bg-center" style={{ backgroundImage: "url('/assets/hero.png')" }}>
          <Header />
        ...
        <div className='w-full flex flex-col bg-bg2 py-8 md:py-12 px-4'>
          ...
          <div className='flex flex-col md:flex-row gap-6 md:gap-10 w-full items-center justify-center'>
            ...
            <div className="flex flex-col bg-white w-full sm:w-4/5 md:w-1/3 h-auto items-center justify-center p-4 rounded-lg shadow-lg">
              <img src={hiw1} alt="Client Submission" className="w-14 md:w-20 h-14 md:h-20" />
            ...
            {/* Card 2 */}
            <div className="flex flex-col bg-white w-full sm:w-4/5 md:w-1/3 h-auto items-center justify-center p-4 rounded-lg shadow-lg">
              <img src={hiw2} alt="Case Matching" className="w-14 md:w-20 h-14 md:h-20" />
            ...
            {/* Card 3 */}
            <div className="flex flex-col bg-white w-full sm:w-4/5 md:w-1/3 h-auto items-center justify-center p-4 rounded-lg shadow-lg">
              <img src={hiw3} alt="Legal Assistance" className="w-14 md:w-20 h-14 md:h-20" />
