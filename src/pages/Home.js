        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center text-center text-white px-6">
            ...
            <p className="mt-4 md:mt-6 text-lg sm:text-xl md:text-2xl max-w-3xl">
              Explore a world of endless possibilities. Discover, learn, and
              grow with our exclusive resources and expert guidance.
            </p>

            <div className="mt-8">
              <button className="text-white bg-green-700 flex items-center px-6 py-3 rounded-lg text-lg hover:bg-green-800 transition">
        ...
        <div className="w-full flex flex-col bg-bg2 py-8 md:py-12 px-4">
          ...
          <div className="flex flex-col md:flex-row gap-6 md:gap-10 w-full items-center justify-center">
            ...
            <div className="flex flex-col bg-white w-full sm:w-4/5 md:w-1/3 h-auto items-center justify-center p-4 rounded-lg shadow-lg">
              ...
              />
              <h1 className="text-lg md:text-xl pt-3 md:pt-5 pb-3 md:pb-5 text-center font-semibold">
                Client Case Submission
              </h1>
              <p className="px-4 pb-3 md:pb-5 text-center text-sm">
                Clients register and provide essential case details, including
                type, legal issue, location, and urgency, to match with the
                right lawyers.
              </p>
            </div>
            ...
            <div className="flex flex-col bg-white w-full sm:w-4/5 md:w-1/3 h-auto items-center justify-center p-4 rounded-lg shadow-lg">
              ...
              <p className="px-4 pb-3 md:pb-5 text-center text-sm">
                The platform’s smart matching system recommends lawyers based on
                expertise, availability, and location, ensuring the best fit.
              </p>
            </div>
            ...
            <div className="flex flex-col bg-white w-full sm:w-4/5 md:w-1/3 h-auto items-center justify-center p-4 rounded-lg shadow-lg">
              ...
              <p className="px-4 pb-3 md:pb-5 text-center text-sm">
                Clients receive real-time updates, reminders, and messaging
                features for seamless communication with legal professionals.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row w-full bg-bg p-6 md:p-10 items-center justify-between text-center md:text-left">
          ...
          <div className="w-full md:w-3/2 flex flex-col items-center md:items-center">
            <p className="max-w-xl text-sm sm:text-base mb-5 px-4">
              Our intelligent matching algorithm ensures clients connect with
              the best-suited lawyers based on expertise and availability,
              streamlining the legal consultation process.
            </p>
            <button
